...
final class MachineViewModel {
    ...
    //tutti possono leggere ma solo questa classe può scrivere
    ...
    // MARK: - Data ingestion (called by AppViewModel)
    ...
    /// Invia SET (1) → attende pulseDuration → invia RESET (0).
    /// Simula la pressione di un pulsante fisico su un marker PLC stateless.
